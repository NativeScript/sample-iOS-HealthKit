...
var titleProperty = new dependencyObservable.Property("title", "Page", new proxy.PropertyMetadata("", dependencyObservable.PropertyMetadataSettings.AffectsLayout));
function onTitlePropertyChanged(data) {
    var button = data.object;
    button._onTitlePropertyChanged(data);
}
titleProperty.metadata.onSetNativeValue = onTitlePropertyChanged;
var Page = (function (_super) {
    ...
    Object.defineProperty(Page.prototype, "title", {
        get: function () {
            return this._getValue(Page.titleProperty);
        },
        set: function (value) {
            this._setValue(Page.titleProperty, value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Page.prototype._onTitlePropertyChanged = function (data) {
    };
    ...
    Page.titleProperty = titleProperty;
    return Page;
